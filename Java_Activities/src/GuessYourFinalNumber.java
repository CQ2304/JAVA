...
public class GuessYourFinalNumber {
    public static void main(String[]args){
        byte a=3;
        JOptionPane.showMessageDialog(null,"Bienvenido, a continuacion te solicitare que pienses en un numero");
         JOptionPane.showMessageDialog(null,"Ahora multiplica tu numero por2");
